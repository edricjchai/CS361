...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		emp3.whoAmI();
		// TODO To complete :)
		// emp3.whoAmI() // prints ...PART TIME EMPLOYEE because ... polymorphism, the child method overwrote the parent method
		// emp3.getHourlyRate(); // returns syntax error because ... "undefined for Employee" emp3 is an Employee
		...
		// because ... Employee is not a subclass of PartTimeEmployee
